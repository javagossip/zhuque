...
# Database: zhuque
# Generation Time: 2019-01-15 10:43:05 +0000
# ************************************************************
...
CREATE TABLE `campaign` (
  ...
  `tracking_solution` int(11) DEFAULT NULL COMMENT '跟踪解决方案',
  `imp_trackers` varchar(255) DEFAULT NULL COMMENT '曝光跟踪url',
  `clk_trackers` varchar(255) DEFAULT NULL COMMENT '点击跟踪url',
  `is_freq_capping` tinyint(1) DEFAULT NULL COMMENT '是否启用频次控制',
  `freq_capping_setting` varchar(255) DEFAULT NULL COMMENT '频次控制设置',
